        ...
        <div className="flex items-center gap-1 px-4 py-1.5 border-b border-slate-800 bg-slate-900/90 overflow-x-auto scrollbar-thin text-xs text-slate-400">
          ...
          <button
            onClick={() =>
              handleInsertTag(
                inputMode === 'html'
                  ? `<div class="diagram-converging" style="margin: 20pt 0; width: 100%; border: 1.5pt solid #CBD5E1; border-radius: 8pt; background-color: #F8FAFC; padding: 16pt;">\n  <table style="width: 100%; border-collapse: separate; border-spacing: 12pt 0; border: none; margin-bottom: 8pt;">\n    <tr>\n      <td style="width: 48%; background-color: #EFF6FF; border: 1.5pt solid #3B82F6; border-radius: 6pt; padding: 12pt; text-align: center;">\n        <div style="font-size: 10.5pt; font-weight: 800; color: #1E40AF; text-transform: uppercase; margin-bottom: 4pt;">SAUDI NATIONAL CURRICULUM</div>\n        <div style="font-size: 8.5pt; color: #475569; font-weight: 500;">(Statutory Core &amp; Identity)</div>\n      </td>\n      <td style="width: 48%; background-color: #F0FDF4; border: 1.5pt solid #22C55E; border-radius: 6pt; padding: 12pt; text-align: center;">\n        <div style="font-size: 10.5pt; font-weight: 800; color: #166534; text-transform: uppercase; margin-bottom: 4pt;">INTERNATIONAL BENCHMARK FRAMEWORK</div>\n        <div style="font-size: 8.5pt; color: #475569; font-weight: 500;">(Pedagogy, Progression &amp; Rigour)</div>\n      </td>\n    </tr>\n  </table>\n  <div style="text-align: center; margin: 4pt 0 10pt 0; color: #2563EB; font-size: 14pt; font-weight: bold; letter-spacing: 0.2em;">↘ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ⬇ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ↙</div>\n  <div style="background-color: #FFFFFF; border: 2pt solid #1E3A8A; border-radius: 6pt; overflow: hidden; text-align: center;">\n    <div style="background-color: #1E3A8A; color: #FFFFFF; padding: 10pt 14pt; font-size: 11pt; font-weight: 800; text-transform: uppercase;">ALKAWTHAR INTEGRATED CURRICULUM ECOSYSTEM</div>\n    <div style="padding: 10pt 16pt; color: #334155; font-size: 9.5pt; line-height: 1.5; font-weight: 500;">(Academically Rigorous, Culturally Grounded, and Globally Competitive KG-Y6)</div>\n  </div>\n</div>`
                  : `SAUDI NATIONAL CURRICULUM                INTERNATIONAL BENCHMARK FRAMEWORK\n(Statutory Core & Identity)              (Pedagogy, Progression & Rigour)\n             \\                                       /\n              \\                                     /\n               --->   ALKAWTHAR INTEGRATED     <---\n                      CURRICULUM ECOSYSTEM\n                    (Academically Rigorous,\n                    Culturally Grounded, and\n                   Globally Competitive KG-Y6)`
              )
            }
            className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 hover:text-white transition shrink-0 flex items-center gap-1 text-cyan-300 border border-cyan-500/30"
          >
            <Layers className="w-3 h-3 text-cyan-400" />
            <span>Convergence Flowchart</span>
          </button>
          ...
          <button
            onClick={() =>
              handleInsertTag(
                inputMode === 'html'
                  ? `<div class="diagram-streams-matrix" style="margin: 18pt 0; width: 100%; border: 1.5pt solid #1E3A8A; border-radius: 8pt; overflow: hidden;">\n  <div style="background-color: #1E3A8A; color: #FFFFFF; padding: 10pt 16pt; text-align: center; font-size: 11pt; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase;">INSTITUTIONAL AUDIT STREAMS</div>\n  <table style="width: 100%; border-collapse: collapse; border: none; background-color: #FFFFFF;">\n    <tr>\n      <td style="width: 25%; vertical-align: top; padding: 12pt 10pt; border-right: 1px solid #E2E8F0; background-color: #FFFFFF;">\n        <div style="font-size: 9.5pt; font-weight: 700; color: #1E3A8A; text-transform: uppercase; margin-bottom: 6pt; border-bottom: 1.5pt solid #DBEAFE; padding-bottom: 4pt;">1. CURRICULAR AUDIT</div>\n        <div style="font-size: 8.5pt; color: #475569; line-height: 1.5;">Scope, sequencing, and vertical alignment of national/global texts.</div>\n      </td>\n      <td style="width: 25%; vertical-align: top; padding: 12pt 10pt; border-right: 1px solid #E2E8F0; background-color: #F8FAFC;">\n        <div style="font-size: 9.5pt; font-weight: 700; color: #1E3A8A; text-transform: uppercase; margin-bottom: 6pt; border-bottom: 1.5pt solid #DBEAFE; padding-bottom: 4pt;">2. PEDAGOGIC AUDIT</div>\n        <div style="font-size: 8.5pt; color: #475569; line-height: 1.5;">Classroom observations, instructional routines, and student engagement.</div>\n      </td>\n      <td style="width: 25%; vertical-align: top; padding: 12pt 10pt; border-right: 1px solid #E2E8F0; background-color: #FFFFFF;">\n        <div style="font-size: 9.5pt; font-weight: 700; color: #1E3A8A; text-transform: uppercase; margin-bottom: 6pt; border-bottom: 1.5pt solid #DBEAFE; padding-bottom: 4pt;">3. ASSESSMENT AUDIT</div>\n        <div style="font-size: 8.5pt; color: #475569; line-height: 1.5;">Validity, frequency, moderation mechanisms, and data utilisation.</div>\n      </td>\n      <td style="width: 25%; vertical-align: top; padding: 12pt 10pt; background-color: #F8FAFC;">\n        <div style="font-size: 9.5pt; font-weight: 700; color: #1E3A8A; text-transform: uppercase; margin-bottom: 6pt; border-bottom: 1.5pt solid #DBEAFE; padding-bottom: 4pt;">4. GOVERNANCE &amp; OPS</div>\n        <div style="font-size: 8.5pt; color: #475569; line-height: 1.5;">Leadership routines, QA protocols, resourcing &amp; infrastructure readiness.</div>\n      </td>\n    </tr>\n  </table>\n</div>`
                  : `+-------------------------------------------------------------------------------------------------------------------+\n|                                             INSTITUTIONAL AUDIT STREAMS                                           |\n+--------------------------+-----------------------------+------------------------------+---------------------------+\n| 1. CURRICULAR AUDIT      | 2. PEDAGOGIC AUDIT          | 3. ASSESSMENT AUDIT          | 4. GOVERNANCE & OPS       |\n| Scope, sequencing, and   | Classroom observations,     | Validity, frequency,         | Leadership routines, QA   |\n| vertical alignment of    | instructional routines,     | moderation mechanisms,       | protocols, resourcing &   |\n| national/global texts.   | and student engagement.     | and data utilisation.        | infrastructure readiness. |\n+--------------------------+-----------------------------+------------------------------+---------------------------+`
              )
            }
            className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 hover:text-white transition shrink-0 flex items-center gap-1 text-indigo-300 border border-indigo-500/30"
          >
            <Bookmark className="w-3 h-3 text-indigo-400" />
            <span>Audit Streams (4 Cols)</span>
          </button>
